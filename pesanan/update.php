...
if (isset($_GET['id'])) {
  ...
  $q = $conn->query("SELECT * FROM pesanan WHERE id_psn = '$id'");
...
<br>
  ...
  <form action="proses_update.php" method="post">
    <input type="hidden" name="id_psn" value="<?= $dt['id_psn'] ?>">
    <input type="text" name="nama" value="<?= $dt['nama'] ?>">
    <input type="text" name="tanggal" value="<?= $dt['tanggal'] ?>">
    <input type="varchar" name="alamat" value="<?= $dt['alamat'] ?>">
    <input type="varchar" name="kurir" value="<?= $dt['kurir'] ?>">
